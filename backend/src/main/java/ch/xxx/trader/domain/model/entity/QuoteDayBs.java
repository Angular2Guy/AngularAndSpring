...
@Document
public class QuoteDayBs implements Quote,QuotePairBs {
	...
	public QuoteDayBs(@JsonProperty("high") BigDecimal high, @JsonProperty("last") BigDecimal last, @JsonProperty("timestamp") Date timestamp, @JsonProperty("bid") BigDecimal bid, @JsonProperty("vwap") BigDecimal vwap, @JsonProperty("volume") BigDecimal volume,
