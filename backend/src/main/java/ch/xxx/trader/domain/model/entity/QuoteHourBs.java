...
@Document
public class QuoteHourBs implements Quote,QuotePairBs {
	...
	public QuoteHourBs(@JsonProperty("high") BigDecimal high, @JsonProperty("last") BigDecimal last, @JsonProperty("timestamp") Date timestamp, @JsonProperty("bid") BigDecimal bid, @JsonProperty("vwap") BigDecimal vwap, @JsonProperty("volume") BigDecimal volume,
