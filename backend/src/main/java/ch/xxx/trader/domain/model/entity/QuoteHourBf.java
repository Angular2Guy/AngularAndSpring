...
@Document
public class QuoteHourBf implements Quote,QuotePairBf {
	...
	public QuoteHourBf(@JsonProperty("mid") BigDecimal mid, @JsonProperty("bid") BigDecimal bid, @JsonProperty("ask") BigDecimal ask, @JsonProperty("last_price") BigDecimal last_price, @JsonProperty("low") BigDecimal low,
