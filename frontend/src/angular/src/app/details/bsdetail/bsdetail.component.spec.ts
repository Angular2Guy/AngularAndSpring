...
describe("BsdetailComponent", () => {
  ...
  it("should show last", () => {
    ...
    expect(el.textContent.trim()).toEqual("2.00");
  });
  it("should show high", () => {
    const de: DebugElement = fixture.debugElement;
  ...
  it("should show low", () => {
    ...
    expect(el.textContent.trim()).toEqual("6.00");
  });
  it("should show bid", () => {
    const de: DebugElement = fixture.debugElement;
  ...
  it("should show open", () => {
    ...
    expect(el.textContent.trim()).toEqual("8.00");
  });
  it("should show vwap", () => {
    const de: DebugElement = fixture.debugElement;
    const el: HTMLElement = de.query(By.css("#vwap")).nativeElement;
    expect(el.textContent.trim()).toEqual("4.00");
  });
  it("should show createdAt", () => {
    ...
    const dateStr =
      ...
      (myDate.getSeconds().toString().length === 1
        ? "0" + myDate.getSeconds()
        : myDate.getSeconds());
    expect(el.textContent.substr(4, el.textContent.length).trim()).toEqual(dateStr.trim());
  });
